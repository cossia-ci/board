...
edit_node=()=>{
	...
	if( node ){
        ...
        set_for_type( node.original.type_ );
    ...
    if( node ){
        ...
        Swal.fire({
            ...
            if( result.value === true ){
                console.log( ano );
                $.when( ajax_from({table: 'front_menu', ano: ano}, '/del-ajax-basic') ).done(function(data){
                    if( data ){
