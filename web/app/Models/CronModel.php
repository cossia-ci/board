...
class CronModel
{
    private $crontab_path = '/usr/bin/';
    private $crontab = 'crontab';
    private $cron_table = array();
    private $is_loaded = false;
    private $error_msg = '';
    private $php_path = '/usr/local/bin/php';
    private $cli_path = '/var/www/html/spark';
    public $cli_list = [
        'bill' => '정기결제 주문처리',
        'order:naver'=>'네이버 주문 자동취합'
    ];
