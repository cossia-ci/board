...
class DBTableField
{
    public static function co_manager() : array
    {
        $fields = [
            ...
            'uuid' => ['type' => 'varchar', 'constraint' => 255, 'null' => true, 'comment'=>'앱토큰',],
    ...
    public static function co_member() : array
    {
        $fields = [
            ...
            'socialId' => ['type' => 'varchar', 'constraint' => 255, 'null' => true, 'comment'=>'소셜아이디', 'key'=>true],
            'password' => ['type' => 'varchar', 'constraint' => 255, 'null' => true, 'comment'=>'비밀번호',],
            ...
            'uuid' => ['type' => 'text', 'null' => true, 'comment'=>'앱토큰',],
            'channel' => ['type' => 'varchar', 'constraint' => 20, 'default' => 'self', 'comment'=>'가입경로',],
            'agreed' => ['type' => 'json', 'null' => true, 'comment'=>'동의',],
            'regDt' => ['type' => 'datetime','null' => true, 'comment'=>'등록일',],
            'editDt' => ['type' => 'datetime', 'null' => true, 'comment'=>'수정일',],
            'delDt' => ['type' => 'datetime','null' => true, 'comment'=>'삭제일',],
        ];
    ...
    public static function co_boardList() : array
	{
		$fields = [
            'ano' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true,],
            'code' => ['type' => 'varchar', 'constraint' => 255, 'null' => true,],
    ...
    public static function co_adminMenu() : array
    {
        $fields = [
            'ano' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true,],
    ...
    public static function co_frontMenu() : array
    {
        $fields = [
            'ano' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true,],
            'parent' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'null' => false, 'default' => 0, 'comment'=>'부모번호', 'key'=>true,],
            ...
            'needLogin' => ['type' => 'enum', 'constraint' => ['y','n'], 'default' => 'n', 'comment'=>'로그인필요여부',],

            'imgPath' => ['type' => 'varchar', 'constraint' => 255, 'null' => true, 'comment'=>'이미지PATH',],
    ...
    public static function co_qna() : array
	{
		$fields = [
            'ano' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true,],
			'user_ano' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true,],
            'etc' => ['type' => 'json', 'null' => true,],
			'title' => ['type' => 'varchar', 'constraint' => 255, 'null' => true,],
